...
int main() {
    ...
    SolutionAndIteration sol_and_it = get_large_neighborhood_search_with_local_search(dataset_a, dist_a);
    // SolutionAndIteration sol_and_it = get_large_neighborhood_search(dataset_a, dist_a);
    Solution& sol = sol_and_it.solution;
