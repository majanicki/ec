...
38, 0, 80, 183, 196, 21, 73, 78, 127, 147, 48, 82, 23, 177, 10, 86, 56, 160, 28, 146, 31, 175, 135, 163, 2, 157, 97, 126, 65, 62, 184, 17, 94, 115, 52, 161, 189, 118, 162, 149, 139, 191, 30, 25, 15, 199, 138, 165, 53, 156, 188, 169, 151, 143, 18, 110, 84, 60, 74, 198, 181, 43, 170, 72, 108, 153, 79, 14, 12, 58, 71, 32, 89, 166, 99, 131, 192, 6, 145, 140, 85, 39, 133, 77, 178, 83, 46, 51, 37, 75, 193, 164, 187, 129, 137, 4, 167, 40, 81, 117, 38

![Visualization of Random Algorithm's best solution for TSPA](random_a.png "Random")
...
![Visualization of Nearest Neighbor #1 best solution for TSPA](nearest_neighbor_end_only_a.png "Nearest Neighbor #1")

### Nearest neighbor #2

The lowest cost is `78,896`.

118, 51, 176, 137, 183, 89, 23, 186, 143, 117, 93, 140, 0, 80, 151, 162, 133, 63, 79, 94, 124, 53, 97, 26, 100, 152, 1, 2, 120, 44, 25, 78, 16, 171, 175, 113, 56, 31, 145, 179, 92, 129, 57, 185, 106, 52, 55, 178, 49, 102, 14, 62, 9, 148, 144, 40, 119, 81, 196, 165, 90, 101, 86, 75, 180, 154, 135, 70, 123, 112, 4, 84, 127, 59, 65, 149, 131, 116, 43, 42, 181, 160, 54, 30, 177, 10, 190, 184, 34, 193, 159, 22, 146, 18, 108, 41, 139, 46, 68, 115, 118

![Visualization of Nearest Neighbor #2 best solution for TSPA](nearest_neighbor_all_positions_a.png "Nearest Neighbor #2")
...
![Visualization of Greedy Cycle Algorithm's best solution for TSPA](greedy_cycle_a.png "Nearest All Positions Algorithm")
...
Random solution achieved lowest cost of `190,834`.

34, 192, 55, 119, 31, 77, 37, 124, 186, 75, 29, 154, 50, 106, 109, 7, 112, 32, 28, 156, 142, 100, 139, 168, 41, 12, 187, 51, 161, 33, 140, 93, 117, 63, 13, 25, 68, 104, 90, 86, 189, 43, 70, 190, 176, 115, 173, 195, 118, 44, 126, 172, 47, 185, 122, 145, 14, 53, 151, 175, 21, 123, 11, 136, 87, 171, 166, 131, 196, 160, 147, 94, 36, 49, 133, 54, 56, 17, 42, 99, 83, 110, 89, 72, 98, 39, 141, 144, 159, 111, 78, 27, 121, 65, 71, 120, 149, 4, 101, 0, 34

![Visualization of Random Algorithm's best solution for TSPB](random_b.png "Random")

### Nearest neighbor #1

The lowest cost is `52,319`.
...
![Visualization of Nearest Neighbor #1 best solution for TSPB](nearest_neighbor_end_only_b.png "Nearest Neighbor #1")

### Nearest neighbor #2

The lowest cost is `52,992`.

10, 133, 122, 90, 51, 121, 117, 198, 1, 38, 27, 31, 73, 193, 190, 80, 175, 78, 142, 45, 5, 177, 36, 61, 91, 141, 77, 81, 153, 187, 163, 89, 103, 114, 127, 165, 137, 176, 166, 194, 86, 185, 95, 130, 99, 62, 124, 106, 143, 0, 35, 109, 29, 33, 160, 144, 8, 82, 21, 104, 111, 138, 182, 11, 139, 168, 195, 145, 3, 155, 15, 70, 169, 132, 13, 188, 6, 147, 18, 55, 34, 152, 183, 140, 20, 28, 149, 4, 148, 60, 47, 94, 66, 179, 113, 54, 135, 63, 40, 107, 10

![Visualization of Nearest Neighbor #2 best solution for TSPB](nearest_neighbor_all_positions_b.png "Nearest Neighbor #2")

### Greedy cycle

The lowest cost is `49,001`.
...
![Visualization of Greedy Cycle Algorithm's best solution for TSPB](greedy_cycle_b.png "Nearest All Positions Algorithm")
# Conclusions
